...
async function sendForms() {
  ...
  try {
    ...
    try {
      ...
      // ensure it's a string, then always prepend
      const subjectWithPrefix = String(subject || "").trim();
      const finalSubject = `Reminder: ${subjectWithPrefix}`;
